const BG1 = () => {
	return (
		<div className="inset-0 bg-background">
			{/* Outer circle */}
			<div className="absolute w-[80rem] sm:w-[90rem] md:w-[100rem] lg:w-[120rem] xl:w-[135rem] h-[80rem] sm:h-[90rem] md:h-[100rem] lg:h-[120rem] xl:h-[135rem] rounded-full border border-yellow-600 origin-center top-[17%] md:top-[12%] left-1/2 -translate-x-1/2 -translate-y-1/2" />
			
			<div className="absolute w-[130rem] h-[130rem] rounded-[50%] border border-yellow-600 origin-center top-[27%] left-1/2 -translate-x-1/2 -translate-y-1/2"></div>
