...
function UtilityCard({
	...
	return (
		<div
			className={`min-w-64 max-w-md h-fit border rounded-2xl p-6 items-center bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-0 bg-white/5 ${styles[theme]} ${styles[size]} ${className}`}
		>
			{/* Icon */}
