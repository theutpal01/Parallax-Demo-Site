...
function Join() {
	return (
		<div className="h-screen mx-auto flex items-end">
			<div className="relative w-full gap-10 p-10 border-b border-l rounded-3xl border-b-violet-950 border-l-violet-950 font-manrope mx-auto text-center flex flex-col items-center justify-center py-10 pt-28 bg-clip-padding backdrop-filter backdrop-blur bg-opacity-0 bg-white/5 bg-gradient-to-tr from-primary-dark/25 via-white/5 to-transparent">
